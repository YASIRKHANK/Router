  ...
  return (
    <div style={backgroundStyle} className='flex gap-x-6 mt-6'>
      ...
      <div className='w-1/2 px-12 py-2 '>
        <h1 className='text-3xl font-bold text-black '>AtmosBit Software House</h1>
        <p className=' tracking-widest font-[arial] text-justify p-2 text-white font-extrabold'> Atmosbit Software House is a cutting-edge and innovative technology company that specializes in delivering high-quality software solutions to meet the diverse needs of businesses and organizations. With a team of skilled and passionate developers, designers, and engineers, Atmosbit takes pride in crafting tailor-made software applications that empower clients to thrive in today's digital landscape.
      ...
      <div className='w-1/2 px-12 py-4  '>
        ...
        <p className='font-extrabold p-3 text-black'>Vision of Atmosbit Software House:</p>
        ...
        <p className='font-extrabold p-3 text-black'>Mission of Atmosbit Software House:</p>
